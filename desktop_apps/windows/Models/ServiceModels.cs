    ...
    public static IReadOnlyList<ServiceDefinition> Create()
    {
        var definitions = new[]
        {
            ...
            new ServiceDefinition(
                ...
                new[] { "/health" },
                new HashSet<string>(StringComparer.OrdinalIgnoreCase) { "python", "python.exe", "uvicorn", "uvicorn.exe" },
                Directory.Exists(@"source_code\0.4_IDP文档录入引擎_V3.1") ? @"0.4_IDP文档录入引擎_V3.1" : @"0.4_IDP文档录入引擎_V3.0",
                ServiceStartKind.PythonModule,
                Directory.Exists(@"source_code\0.4_IDP文档录入引擎_V3.1") ? @"source_code\0.4_IDP文档录入引擎_V3.1" : @"source_code\0.4_IDP文档录入引擎_V3.0",
                null,
                null,
                "http://127.0.0.1:8933/"),
            new ServiceDefinition(
