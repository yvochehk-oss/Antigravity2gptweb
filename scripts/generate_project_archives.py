...
=============================================================================
覆盖全部 6 大项目：
  1. 01_天府国际金融中心二期_CD-TF-001 (14.5亿)
  2. 02_成渝跨江特大桥及连接线_CY-CQ-002 (8.8亿)
  3. 03_广元利州产城融合与河道治理_GY-LZ-003 (3.6亿)
  4. 04_成都高新西区微电网变电站_CD-GX-004 (1.8亿)
  5. 05_格尔木特种仓储综合配套_QY-GEM-005 (2.5亿)
  6. 06_宜宾示范工业项目_YB-DEMO-001 (1.0亿)

输出目录：
  /Users/yvoche/AI开发/073_成都建工/V2.0/项目存档资料/
=============================================================================
"""
import os
import sys
...
def get_entity_name(code):
    return ENTITIES.get(code, {}).get('name', f"协作单位({code})")
...
PROJECTS_CONFIG = [
    {
        ...
        'contracts': [
            ...
            {'title': '大宗高强抗震钢材集采供销合同', 'seller': 'B01', 'buyer': 'A08', 'cat': '大宗材料采购', 'amount': 450_000_000, 'no': 'TF-A08-B01', 'terms': ['HRB400E高强抗震螺纹钢集采', '全量提供电子地磅单与过磅小票，税率13%']},
            {'title': '建筑主体结构劳务用工分包合同', 'seller': 'C01', 'buyer': 'A08', 'cat': '建筑劳务分包', 'amount': 260_000_000, 'no': 'TF-A08-C01', 'terms': ['严格落实四川省建筑工人实名制考勤与银行代发工资', '税率9%']},
            {'title': '重型塔式起重机及附着式升降脚手架租赁合同', 'seller': 'D01', 'buyer': 'A08', 'cat': '机械设备租赁', 'amount': 110_000_000, 'no': 'TF-A08-D01', 'terms': ['含中联重科8台重型自升式塔吊租赁与维保', '纯租赁税率13%']},
            {'title': '超高层大跨度钢结构专业分包工程合同', 'seller': 'A11', 'buyer': 'A08', 'cat': '钢结构专业分包', 'amount': 280_000_000, 'no': 'TF-A08-A11', 'terms': ['大跨度钢桁架连廊加工与高空液压同步提升', '税率9%']},
            {'title': '建筑弱电智能化及BIM数字微网工程分包合同', 'seller': 'A05', 'buyer': 'A08', 'cat': '弱电集成专业分包', 'amount': 40_000_000, 'no': 'TF-A08-A05', 'terms': ['智慧建筑楼宇自控系统与弱电系统集成', '税率9%']},
        ]
    },
    {
        ...
        'city': '重庆市',
        'contracts': [
            {'title': '跨江特大桥基础设施工程施工总承包合同', 'seller': 'A03', 'buyer': 'EXT-CY', 'cat': '路桥市政施工', 'amount': 880_000_000, 'no': 'CYCQ-MAIN-2026-02', 'terms': ['跨省跨区工程（重庆段就地预缴2%增值税）', '川渝两地企业所得税三因素法分摊申报']},
            {'title': '特种耐候桥梁高强厚板钢材供销合同', 'seller': 'B10', 'buyer': 'A03', 'cat': '桥梁钢材采购', 'amount': 320_000_000, 'no': 'CY-A03-B10', 'terms': ['Q345qD桥梁专用钢板供应', '税率13%']},
            {'title': '高空索塔及深水基础泥瓦特种作业劳务合同', 'seller': 'C02', 'buyer': 'A03', 'cat': '特种劳务分包', 'amount': 140_000_000, 'no': 'CY-A03-C02', 'terms': ['特种高处作业及水上沉井施工班组实名代发', '税率9%']},
            {'title': '重型水上浮吊与大直径旋挖桩机设备租赁合同', 'seller': 'D02', 'buyer': 'A03', 'cat': '水上机械设备租赁', 'amount': 80_000_000, 'no': 'CY-A03-D02', 'terms': ['配置500吨级打桩浮吊及水上驳船作业组', '设备租金税率13%']},
            {'title': '特大桥重庆江北侧引桥及互通立交分包工程合同', 'seller': 'A04', 'buyer': 'A03', 'cat': '分支机构分包工程', 'amount': 120_000_000, 'no': 'CY-A03-A04', 'terms': ['屹明汇重庆分公司属地化施工执行', '税率9%']},
        ]
    },
    {
        ...
        'city': '广元市',
        'contracts': [
            {'title': '水利水运与生态河道综合整治总承包合同', 'seller': 'A10', 'buyer': 'EXT-GY', 'cat': '水利生态总承包', 'amount': 360_000_000, 'no': 'GYLZ-MAIN-2026-03', 'terms': ['河道疏浚、防洪堤防工程与生态景观绿化', '税率9%']},
            {'title': '水利工程专用级配砂石骨料地磅集采合同', 'seller': 'B05', 'buyer': 'A10', 'cat': '砂石材料采购', 'amount': 130_000_000, 'no': 'GY-A10-B05', 'terms': ['广元本地天然砂石骨料供应，全车过磅验收', '税率13%']},
            {'title': '土石方开挖转运与边坡柔性防护专业分包合同', 'seller': 'A09', 'buyer': 'A10', 'cat': '土石方专业分包', 'amount': 60_000_000, 'no': 'GY-A10-A09', 'terms': ['山体边坡加固与35万方土石方挖填平衡', '税率9%']},
            {'title': '水利清淤抽沙绞吸船与大型挖掘机租赁合同', 'seller': 'D03', 'buyer': 'A10', 'cat': '水利设备租赁', 'amount': 38_000_000, 'no': 'GY-A10-D03', 'terms': ['含清淤机具与农田排灌设施设备租用', '税率13%']},
            {'title': '文明施工定型化标识标牌与围挡采购合同', 'seller': 'B06', 'buyer': 'A10', 'cat': '文明施工物资', 'amount': 8_000_000, 'no': 'GY-A10-B06', 'terms': ['全线定型化安全防护网与警示标识', '税率13%']},
        ]
    },
    {
        ...
        'city': '成都市',
        'contracts': [
            {'title': '110kV变电站及配电微网工程总承包合同', 'seller': 'A07', 'buyer': 'EXT-GX', 'cat': '电力总承包工程', 'amount': 180_000_000, 'no': 'CDGX-MAIN-2026-04', 'terms': ['110kV智能变电站设备安装与电缆敷设', '税率9%']},
            {'title': '高低压交联电力电缆与成套配电柜集采合同', 'seller': 'B08', 'buyer': 'A07', 'cat': '电缆电气采购', 'amount': 65_000_000, 'no': 'GX-A07-B08', 'terms': ['特种阻燃铜芯电缆及高压GIS开关柜', '税率13%']},
            {'title': '电气安装五金工具与接地防雷辅材供应合同', 'seller': 'B02', 'buyer': 'A07', 'cat': '五金辅材采购', 'amount': 20_000_000, 'no': 'GX-A07-B02', 'terms': ['铜排、接地极及绝缘辅材供销', '税率13%']},
            {'title': '智能变电站主控楼及防火隔墙土建分包合同', 'seller': 'A02', 'buyer': 'A07', 'cat': '土建专业分包', 'amount': 22_000_000, 'no': 'GX-A07-A02', 'terms': ['变电站站房清水混凝土结构施工', '税率9%']},
        ]
    },
    {
        ...
        'city': '格尔木市',
        'contracts': [
            {'title': '盐湖工业园区特种耐腐仓储设施总承包合同', 'seller': 'A01', 'buyer': 'EXT-GEM', 'cat': '特种工业建筑总承包', 'amount': 250_000_000, 'no': 'QYGEM-MAIN-2026-05', 'terms': ['高原高寒盐雾腐蚀特种防腐仓储厂房', '税率9%']},
            {'title': '高寒特种耐低温保温材料直采供销合同', 'seller': 'B09', 'buyer': 'A01', 'cat': '特种耐寒材料采购', 'amount': 55_000_000, 'no': 'GEM-A01-B09', 'terms': ['聚氨酯低温保温板与密封结构胶', '税率13%']},
            {'title': '耐腐蚀耐候特种合金钢构件采购合同', 'seller': 'B03', 'buyer': 'A01', 'cat': '耐候钢材采购', 'amount': 35_000_000, 'no': 'GEM-A01-B03', 'terms': ['防盐雾耐酸特种涂层钢结构构件', '税率13%']},
            {'title': '高原集采供应链大宗建材供销合同', 'seller': 'B07', 'buyer': 'A01', 'cat': '大宗物资供应链', 'amount': 20_000_000, 'no': 'GEM-A01-B07', 'terms': ['集采高强度水泥与抗硫酸盐外加剂', '税率13%']},
            {'title': '干混预拌特种砂浆及添加剂采购合同', 'seller': 'B04', 'buyer': 'A01', 'cat': '预拌砂浆采购', 'amount': 15_000_000, 'no': 'GEM-A01-B04', 'terms': ['特种防冻防裂灌浆料供应', '税率13%']},
            {'title': '大型重型特种钢结构仓储厂房制作吊装分包合同', 'seller': 'A06', 'buyer': 'A01', 'cat': '钢结构专业分包', 'amount': 45_000_000, 'no': 'GEM-A01-A06', 'terms': ['高寒高原大跨度门式刚架吊装施工', '税率9%']},
        ]
    },
    {
        ...
        'city': '宜宾市',
        'contracts': [
            {'title': '宜宾三江示范工业园厂房总承包合同', 'seller': 'A08', 'buyer': 'EXT-YB', 'cat': '工业厂房总承包', 'amount': 100_000_000, 'no': 'YBDEMO-MAIN-2026-06', 'terms': ['标准轻钢厂房与配套综合用房', '税率9%']},
            {'title': '主体工程建筑劳务用工分包合同', 'seller': 'C01', 'buyer': 'A08', 'cat': '劳务分包', 'amount': 8_000_000, 'no': 'YB-B-001', 'terms': ['劳务班组实名代发', '税率9%']},
            ...
            {'title': '外部专业劳务协作与技术支持合同', 'seller': 'EXT-CY', 'buyer': 'A08', 'cat': '外部劳务协作', 'amount': 2_000_000, 'no': 'YB-EXT-CY-001', 'terms': ['系统外专家技术服务与劳务配合', '税率6%']},
            {'title': '特种电力配套调试与试验配合合同', 'seller': 'EXT-GX', 'buyer': 'A08', 'cat': '外部设备技术', 'amount': 1_500_000, 'no': 'YB-EXT-GX-001', 'terms': ['高压配电试验与保护定值整定', '税率6%']},
            {'title': '特种防腐耐磨地坪材料直销合同', 'seller': 'EXT-GEM', 'buyer': 'A08', 'cat': '外部材料直供', 'amount': 5_000_000, 'no': 'YB-EXT-GEM-001', 'terms': ['环氧自流平耐磨骨料直供', '税率13%']},
            {'title': '厂区雨污水管网生态开挖分包合同', 'seller': 'EXT-GY', 'buyer': 'A08', 'cat': '外部专业分包', 'amount': 3_000_000, 'no': 'YB-EXT-GY-001', 'terms': ['市政管网顶管与沉井施工', '税率9%']},
        ]
    }
]
...
def generate_all_archives():
    print("=" * 70)
    print("  🚀 开始为成都建工 6 大标杆工程生成全套真实归档资料与四流凭证...")
    print("=" * 70)
    ...
    for p_idx, p in enumerate(PROJECTS_CONFIG, 1):
        ...
        for c_idx, c in enumerate(p['contracts'][1:], 1):
            ...
            tax_rate = 0.13 if ('材料' in cat or '租赁' in cat) else 0.09
            ...
            if '材料' in cat:
                ...
                create_simulated_scan_jpg(
                    ...
                    [
                        ...
                        ("收货单位及料场", f"{get_entity_name(c['buyer'])} · 现场1号钢筋料仓"),
