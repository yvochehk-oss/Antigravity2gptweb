...
DEMO_PROJECTS = [
    ...
    {
        'dir_name': '02_成渝中线高速互通_CY-GS-002',
        'code': 'CY-GS-002',
        'contracts': [
    ...
    {
        'dir_name': '03_广元白龙湖生态涵养_GY-BLH-003',
        'code': 'GY-BLH-003',
        'contracts': [
    ...
    for contract_data in proj_data['contracts']:
        ...
        if seller.startswith("EXT-") or buyer.startswith("EXT-"):
            ...
            if not existing:
                ...
                # Internal entity code for invoice and cashflow
                ...
                inv = Invoice(
                    ...
                    direction="outbound" if seller.startswith("A") else "inbound",
                    category=contract_data['cat'],
                ...
                cf = CashFlow(
                    ...
                    period="2026-03",
                    entity_code=internal_code,
                    direction="inflow" if seller.startswith("A") else "outflow",
                    amount=Decimal(contract_data['amount']) * Decimal('0.6'),
                    flow_date="2026-03-22",
                    counterparty_code=buyer if seller.startswith("A") else seller
                )
                db.add(cf)
