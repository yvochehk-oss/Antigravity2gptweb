...
export function TaxLedgerView({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 台账明细表 */}
      <div className="glass-panel rounded-xl p-3.5 overflow-hidden">
              ...
              <tr className="border-b border-[#444653]/30 text-[11.5px] font-semibold text-[#8e909f]">
                ...
                >
                  <div className="flex items-center gap-1">
                    <div>
                      <div className="text-[11.5px] text-[#8e909f] group-hover:text-[#4cd7f6] truncate">所属工程项目</div>
                      <div className="text-[9.5px] text-[#8e909f]/70 font-normal">工程编码</div>
                    </div>
                ...
                >
                  <div className="flex items-center gap-1">
                    <div>
                      ...
                      <div className="text-[9.5px] text-[#8e909f]/70 font-normal">税款所属期</div>
                    </div>
                ...
                <th className="py-1.5 px-1 text-center whitespace-nowrap">
                  <div>操作</div>
                  <div className="text-[9.5px] text-[#8e909f]/70 font-normal">AI研判</div>
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#444653]/15">
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-1 px-2">
                      <div className="font-bold text-[#dae2fd] text-[12px] leading-tight break-words whitespace-normal" title={rec.projectName}>
                        {rec.projectName}
                      </div>
                      <div className="text-[10px] text-[#8e909f] font-mono-num mt-0.5">
                        {rec.projectCode}
                      </div>
                    </td>
                    ...
                    {/* 实体名称与标段分类 */}
                    <td className="py-1 px-2">
                      <div className={`font-semibold text-[12px] leading-tight break-words whitespace-normal ${isHighRisk ? 'text-[#ffb4ab]' : 'text-[#dde1ff]'}`} title={rec.entityName}>
                        {rec.entityName}
                      </div>
                    ...
                    {/* 四流核验 */}
                    <td className="py-1 px-1 text-center whitespace-nowrap">
                      <span className={`inline-flex items-center justify-center whitespace-nowrap text-[10px] px-1 py-0.2 rounded border font-medium ${
                    ...
                    <td className="py-1 px-1 text-center whitespace-nowrap">
                      <button
                        ...
                        className="px-2 py-0.5 text-[10.5px] font-semibold bg-[#1e40af]/60 hover:bg-[#1e40af] text-[#dde1ff] rounded border border-[#4cd7f6]/30 cursor-pointer transition-colors"
                      >
                        AI研判
                      </button>
                    </td>
