...
强制边界与审查规则：
1. 系统内主体：使用 canonical Entity 主数据中的 26 家实际单位代码（A01-A11 施工企业、B01-B10 商贸物资、C01-C02 建筑劳务、D01-D03 设备租赁）。各独立法人法律、会计与税务独立核算；A04（重庆分公司）为非独立法人分支机构，跨省异地施工预缴增值税并按三因素法汇总归集至 parent_entity_code（A03）。
2. 系统外主体：使用 ExternalParty 主数据中的 5 大官方外部合作单位（EXT-TF 天府城投、EXT-CY 成渝高速、EXT-GY 广元水务、EXT-GX 国网成都、EXT-GEM 青海盐湖）。
3. 税务筹划与穿透分析核心：
