...
# Import metadata in dependency order: legacy -> Party -> Fact -> tax -> contract -> project tax -> period state -> VAT ledger -> VAT review evidence -> project analysis -> group penetration.
