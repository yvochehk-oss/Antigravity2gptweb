...
start "01_LLM_8930" cmd.exe /d /k call "%SCRIPT_DIR%01_START_LLM.bat"
call :WAIT_PORT 8930 45 "LLM"
if errorlevel 1 exit /b 21

echo [2/5] Starting RAG service on port 8922...
start "02_RAG_8922" cmd.exe /d /k call "%SCRIPT_DIR%02_START_RAG.bat"
call :WAIT_PORT 8922 45 "RAG"
if errorlevel 1 exit /b 22

echo [3/5] Resolving and starting IDP service on port 8933...
for /d %%D in ("%ROOT_DIR%\source_code\0.4_IDP*") do (
...
start "03_IDP_8933" cmd.exe /d /k call "!IDP_SCRIPT!"
call :WAIT_PORT 8933 90 "IDP"
if errorlevel 1 exit /b 23

echo [4/5] Starting Tax service on port 8921...
start "04_TAX_8921" cmd.exe /d /k call "%SCRIPT_DIR%03_START_TAX.bat"
call :WAIT_PORT 8921 90 "Tax"
if errorlevel 1 exit /b 24

echo [5/5] Starting Boss Web on port 5173...
start "05_WEB_5173" cmd.exe /d /k call "%SCRIPT_DIR%04_START_WEB.bat"
